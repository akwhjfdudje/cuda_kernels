...
float voronoi(float x, float y, int cell_count, int seed) {
...
void cpuGenerateHeightmap(std::vector<float>& out, int width, int height,
...
TEST(GenerateHeightmap, LargeGrid) {
